...
# by Xingpeng.Li
# run command: include fileName.mod; e.g. include DSM_IC_e4_hr1.mod; 
...
minimize obj: sum{g in GEN, t in PERIOD} (gen_OpCost[g]*Pg[g,t] + gen_NlCost[g]*u[g,t] + gen_SuCost[g]*v[g,t])
               + sum{t in PERIOD}DSM_d[t]*DSM_Cost;
...
subject to unit_limit {g in GEN, t in PERIOD}: u[g,t] = 1; 


# Load data
data DSM_IC_e4_hr1_data.txt;
